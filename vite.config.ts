...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    define: {
      ...
      'import.meta.env.VITE_WRISTO_PADDLE_ENVIRONMENT': JSON.stringify(envValue(rootEnv, 'VITE_WRISTO_STUDIO_PADDLE_ENVIRONMENT', 'VITE_WRISTO_PADDLE_ENVIRONMENT')),
      'import.meta.env.VITE_WRISTO_PADDLE_CLIENT_TOKEN': JSON.stringify(envValue(rootEnv, 'VITE_WRISTO_STUDIO_PADDLE_CLIENT_TOKEN', 'VITE_WRISTO_PADDLE_CLIENT_TOKEN')),
