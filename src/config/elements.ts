...
import type { ElementConfigs, ElementAttribute } from '@/types/elements/config'

// 元素默认配置
export const elementAttribute: ElementAttribute = {
  left: 227,
  top: 227,
  width: 100,
  height: 40,
...
const indicatorAttribute: ElementAttribute = assign({}, elementAttribute, {
  left: 227,
  top: 227,
  originX: 'center',
  originY: 'center',
