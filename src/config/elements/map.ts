...
import { DEFAULT_DATA_CONFIG, DEFAULT_LABEL_CONFIG, DEFAULT_UNIT_CONFIG, DEFAULT_ICON_CONFIG, DEFAULT_MOON_CONFIG, DEFAULT_WEATHER_CONFIG } from './defaults/metric'
