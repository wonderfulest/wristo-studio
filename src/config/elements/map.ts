...
import { DEFAULT_INDICATOR_CONFIG } from './defaults/indicator'
...
export const elementConfigs: Record<string, Record<string, AnyElementConfig & EDITOR_ELEMENT>> = {
  ...
  indicator: {
    bluetooth: DEFAULT_INDICATOR_CONFIG,
    disturb: DEFAULT_INDICATOR_CONFIG,
    alarms: DEFAULT_INDICATOR_CONFIG,
    notification: DEFAULT_INDICATOR_CONFIG,
  },
  shape: {
