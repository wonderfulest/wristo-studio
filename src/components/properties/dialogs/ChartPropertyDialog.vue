  ...
  >
    ...
    >
      <div class="property-hero">
        <div>
          <div class="property-hero-kicker">{{ t('property.chartSelect') }}</div>
          <div class="property-hero-title">{{ formData.title || t('property.chartSelect') }}</div>
        </div>
        <code class="property-hero-key">prop.{{ formData.propertyKey || 'chart_1' }}</code>
      </div>
      ...
      <div class="form-section">
        <div class="section-header">
          <h3 class="section-title">{{ t('property.chartOptions') }}</h3>
        </div>
        <el-form-item 
        ...
        <el-collapse v-model="activeOptions" class="options-collapse">
          <el-collapse-item :title="t('property.chartOptions')" name="options">
            <el-form-item 
              prop="options"
              :rules="[
