...
const loadDesign = (design: Design) => {
  ...
  if (design.product) {
    ...
    form.price = form.paymentMethod === 'free' ? 0 : (design.product.payment?.price ?? 1.99)
...
const handleConfirm = async () => {
  ...
  if (form.paymentMethod !== 'free' && (!Number.isFinite(form.price) || form.price < 1.99 || form.price > 99.99)) {
