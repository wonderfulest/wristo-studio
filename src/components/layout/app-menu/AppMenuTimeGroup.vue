  ...
  <el-sub-menu index="time">
    ...
    <div class="menu-group">
      ...
      >
        ...
        <span>{{ t('editor.monthDayWithWeekday') }}</span>
      </el-menu-item>
      <el-menu-item
      ...
      >
        <el-icon><Calendar /></el-icon>
        <span>{{ t('editor.monthDayYear') }}</span>
      </el-menu-item>
    </div>
