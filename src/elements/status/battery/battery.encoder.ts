...
export function encodeBattery(element: Partial<FabricElement>): BatteryElementConfig {
  ...
  const config: BatteryElementConfig = {
    ...
    bodyStrokeProperty: anyElement.bodyStrokeProperty ?? undefined,
    bodyFill: batteryBody.fill,
    bodyFillProperty: anyElement.bodyFillProperty ?? undefined,
    ...
    headFillProperty: anyElement.headFillProperty ?? undefined,
    ...
    levelColorMediumProperty: anyElement.levelColorMediumProperty ?? undefined,
    levelColorHigh: (anyElement.levelColorHigh ?? DEFAULT_LEVEL_COLOR_HIGH) as string,
    levelColorHighProperty: anyElement.levelColorHighProperty ?? undefined,
...
export function decodeBattery(config: BatteryElementConfig): Partial<FabricElement> {
  const decoded: Partial<FabricElement> = {
    ...
    bodyStrokeProperty: config.bodyStrokeProperty ?? undefined,
    bodyFill: config.bodyFill,
    bodyFillProperty: config.bodyFillProperty ?? undefined,
    ...
    headFillProperty: config.headFillProperty ?? undefined,
    headRx: config.headRx,
    headRy: config.headRy,
    padding: config.padding,
    level: config.level,
    levelColorLow: config.levelColorLow ?? DEFAULT_LEVEL_COLOR_LOW,
    levelColorLowProperty: config.levelColorLowProperty ?? undefined,
    levelColorMedium: config.levelColorMedium ?? DEFAULT_LEVEL_COLOR_MEDIUM,
    levelColorMediumProperty: config.levelColorMediumProperty ?? undefined,
    levelColorHigh: config.levelColorHigh ?? DEFAULT_LEVEL_COLOR_HIGH,
    levelColorHighProperty: config.levelColorHighProperty ?? undefined,
