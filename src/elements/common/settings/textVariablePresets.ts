...
export const textVariablePresets: TextVariablePreset[] = [
  ...
  { key: 'text_weather_description', title: 'Weather Description', value: '{{weatherDesc}}' },
  { key: 'text_high_low_temperature', title: 'High / Low Temperature', value: '{{temperatureHigh}}°/{{temperatureLow}}°' },
